...
|------------|---------|--------|-------|-------|------|------|------|------|
| concurrent | 3.6     | 4.4    | 153.5 | 675.8 | 13.7 | 16.9 | 14.4 | 17.7 |
| concurrent | 5.6     | 7.3    | 204.6 | 875.4 | 21.5 | 28.2 | 22.5 | 29.3 |
|============|=========|========|=======|=======|======|======|======|======|
```
...
|            | Mdn     | p95    | Mdn  | p95   | Mdn  | p95  | Mdn  | p95  |
|------------|---------|--------|------|-------|------|------|------|------|
| concurrent | 3.0     | 5.4    | 52.5 | 556.6 | 11.7 | 20.0 | 12.0 | 21.5 |
| concurrent | 3.8     | 5.4    | 60.7 | 310.5 | 15.0 | 21.3 | 15.1 | 21.7 |
|============|=========|========|======|=======|======|======|======|======|
```
